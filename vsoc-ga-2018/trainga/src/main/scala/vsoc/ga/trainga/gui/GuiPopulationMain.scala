...
object GuiPopulationMain extends App with WithPathTrainGaNrRunner {
  ...
  def run(trainGa: TrainGa[Double], populationNr: String, generationNrOpt: Option[String]): Unit = {
  ...
  def createMatch(trainGa: TrainGa[Double], populationNr: String, generationNr: String, popDir: Path): Match = {
