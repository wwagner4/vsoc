...
object Configs {
  ...
  def work015a: Config = new Config {

    override def id: String = "work015a"

    override def trainings: Seq[ConfigTrainGa] = Seq(
      ConfigTrainGa("trainGa04M0om02varL", "w005"),
      ConfigTrainGa("trainGa04M0om02varL", "w006"),
      ConfigTrainGa("trainGa04M0om02varL", "w007"),
      ConfigTrainGa("trainGa04M0om02varL", "w008"),
    )
  ...
  def work016: Config = new Config {

    override def id: String = "work016"

    override def trainings: Seq[ConfigTrainGa] = Seq(
      ConfigTrainGa("trainGa05fitFac01", "w001"),
      ConfigTrainGa("trainGa05fitFac01", "w002"),
      ConfigTrainGa("trainGa05fitFac01", "w003"),
      ConfigTrainGa("trainGa05fitFac02", "w001"),
      ConfigTrainGa("trainGa05fitFac02", "w002"),
      ConfigTrainGa("trainGa05fitFac02", "w003"),
    )

    override def fullDesc: String =
      """Goals are rewarded by a relative to kicks
      """.stripMargin
  }

  def bob016: Config = new Config {

    override def id: String = "bob016"

    override def trainings: Seq[ConfigTrainGa] = Seq(
      ConfigTrainGa("trainGa05fitFac01", "b001"),
      ConfigTrainGa("trainGa05fitFac01", "b002"),
      ConfigTrainGa("trainGa05fitFac02", "b001"),
      ConfigTrainGa("trainGa05fitFac02", "b002"),
    )
  ...
  def bob017: Config = new Config {

    override def id: String = "bob017"

    override def trainings: Seq[ConfigTrainGa] = Seq(
      ConfigTrainGa("trainGa05fitFac03", "b001"),
      ConfigTrainGa("trainGa05fitFac03", "b002"),
      ConfigTrainGa("trainGa05fitFac03", "b003"),
      ConfigTrainGa("trainGa05fitFac03", "b004"),
    )
  ...
  def work017: Config = new Config {

    override def id: String = "work017"

    override def trainings: Seq[ConfigTrainGa] = Seq(
      ConfigTrainGa("trainGa05fitFac03", "w001"),
      ConfigTrainGa("trainGa05fitFac03", "w002"),
      ConfigTrainGa("trainGa05fitFac03", "w003"),
      ConfigTrainGa("trainGa05fitFac03", "w004"),
      ConfigTrainGa("trainGa05fitFac03", "w005"),
      ConfigTrainGa("trainGa05fitFac03", "w006"),
    )
  ...
  def work017b: Config = new Config {

    override def id: String = "work017b"
  ...
  def bob017b: Config = new Config {

    override def id: String = "bob017b"

    override def trainings: Seq[ConfigTrainGa] = Seq(
      ConfigTrainGa("trainGa05fitFac03b", "b001"),
      ConfigTrainGa("trainGa05fitFac03b", "b002"),
      ConfigTrainGa("trainGa05fitFac03b", "b003"),
      ConfigTrainGa("trainGa05fitFac03b", "b004"),
      ConfigTrainGa("trainGa05fitFac03b", "b005"),
      ConfigTrainGa("trainGa05fitFac03b", "b006"),
    )
