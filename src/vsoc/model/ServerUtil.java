...
public class ServerUtil {
    ...
    protected void addFlags(Server srv) {
        ...
        addFlagGoalEast(srv, ServerFlag.NORTH, Server.WIDTH / 2, srv
                .getGoalEast().getGoalWidth() / 2);
        addFlagGoalEast(srv, ServerFlag.SOUTH, Server.WIDTH / 2, -srv
                .getGoalEast().getGoalWidth() / 2);
        addFlagGoalWest(srv, ServerFlag.NORTH, -Server.WIDTH / 2, srv
                .getGoalWest().getGoalWidth() / 2);
        addFlagGoalWest(srv, ServerFlag.SOUTH, -Server.WIDTH / 2, -srv
                .getGoalWest().getGoalWidth() / 2);
    }
    ...
    protected void addFlagGoalEast(Server srv, ServerFlag type, double x,
            double y) {
        FlagGoalEast f = new FlagGoalEast(type, x, y);
        srv.addSimObject(f);
    }

    protected void addFlagGoalWest(Server srv, ServerFlag type, double x,
            double y) {
