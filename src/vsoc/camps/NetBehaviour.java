    ...
    private void initRetinas(Sensors sens) {
        ...
        if (sens.sawFlagLeft()) {
            ...
            while (iter.hasNext()) {
                ...
                this.retinaFlagLeft.addVision(vis.getDistance(), -vis
                        .getDirection());
        ...
        if (sens.sawFlagOwn()) {
            ...
            while (iter.hasNext()) {
                BehaviourVision vis = (BehaviourVision) iter.next();
                this.retinaFlagOwn.addVision(vis.getDistance(), -vis
                        .getDirection());
        ...
        if (sens.sawFlagPenaltyOther()) {
            ...
            while (iter.hasNext()) {
                BehaviourVision vis = (BehaviourVision) iter.next();
                this.retinaFlagPenaltyOther.addVision(vis.getDistance(), -vis
                        .getDirection());
        ...
        if (sens.sawFlagRight()) {
            ...
            while (iter.hasNext()) {
                BehaviourVision vis = (BehaviourVision) iter.next();
                this.retinaFlagRight.addVision(vis.getDistance(), -vis
                        .getDirection());
            }
        }
        ...
        if (sens.sawFlagGoalOther()) {
            ...
            while (iter.hasNext()) {
                BehaviourVision vis = (BehaviourVision) iter.next();
                this.retinaGoalOther.addVision(vis.getDistance(), -vis
                        .getDirection());
            }
        }
        ...
        if (sens.sawPlayerOther()) {
            ...
            while (iter.hasNext()) {
                BehaviourVision vis = (BehaviourVision) iter.next();
                this.retinaPlayerOther.addVision(vis.getDistance(), -vis
                        .getDirection());
        ...
        if (sens.sawPlayerOwn()) {
            ...
            while (iter.hasNext()) {
                BehaviourVision vis = (BehaviourVision) iter.next();
                this.retinaPlayerOwn.addVision(vis.getDistance(), -vis
                        .getDirection());
