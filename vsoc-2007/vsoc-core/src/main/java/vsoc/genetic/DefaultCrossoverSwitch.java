 ...
 */
public class DefaultCrossoverSwitch implements Serializable, CrossoverSwitch {
     ...
     */
    public DefaultCrossoverSwitch(int mean, int var, long seed) {
     ...
     */
    public DefaultCrossoverSwitch(int mean, int var) {
        this.ran = new Random();
        this.mean = mean;
        this.var = var;
        this.count = 0;
