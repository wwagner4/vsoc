...
/**
 * Controller delegating the infos it gets from the atan environment to Sensors.
 * The output of the sensors can be used to control the players
 */
public class BehaviourController implements Controller, Serializable {
	...
	public void infoSeeFlagCenter(Flag flag, double distance, double direction) {
		this.sensors.setSawAnything(true);
		this.sensors.getFlagsCenter().put(flag, new DistDirVision(distance, direction));
	}

	public void infoSeeFlagCornerOwn(Flag flag, double distance, double direction) {
		this.sensors.setSawAnything(true);
		this.sensors.getFlagsCornerOwn().put(flag, new DistDirVision(distance, direction));
	}

	public void infoSeeFlagCornerOther(Flag flag, double distance, double direction) {
		this.sensors.setSawAnything(true);
		this.sensors.getFlagsCornerOther().put(flag, new DistDirVision(distance, direction));
	}

	public void infoSeeFlagPenaltyOwn(Flag flag, double distance, double direction) {
		this.sensors.setSawAnything(true);
		this.sensors.getFlagsPenaltyOwn().put(flag, new DistDirVision(distance, direction));
	}

	public void infoSeeFlagPenaltyOther(Flag flag, double distance, double direction) {
		this.sensors.setSawAnything(true);
		this.sensors.getFlagsPenaltyOther().put(flag, new DistDirVision(distance, direction));
	}

	public void infoSeeFlagGoalOwn(Flag flag, double distance, double direction) {
		this.sensors.setSawAnything(true);
		this.sensors.getFlagsGoalOwn().put(flag, new DistDirVision(distance, direction));
	}

	public void infoSeeFlagGoalOther(Flag flag, double distance, double direction) {
		this.sensors.setSawAnything(true);
		this.sensors.getFlagsGoalOther().put(flag, new DistDirVision(distance, direction));
	}
	...
	public void infoSeePlayerOther(int number, double distance, double direction) {
		this.sensors.setSawAnything(true);
		this.sensors.getPlayersOther().put(number, new DistDirVision(distance, direction));
	}

	public void infoSeePlayerOwn(int number, double distance, double direction) {
		this.sensors.setSawAnything(true);
		this.sensors.getPlayersOwn().put(number, new DistDirVision(distance, direction));
	}
	...
	public void infoSenseBody(ViewQuality viewQuality, ViewAngle viewAngle, double stamina, double speed,
	    double headAngle, int kickCount, int dashCount, int turnCount, int sayCount, int turnNeckCount) {
